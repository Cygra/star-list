...
- [YiNNx/cmd-wrapped](https://github.com/YiNNx/cmd-wrapped)
  - ⭐: 280
  - 📖: Find out what your 2023 looks like in commandline!
  - 💡: `bash` `cli` `commandline` `rust` `zsh`
...
- [tldr-pages/tldr](https://github.com/tldr-pages/tldr)
  ...
  - 💡: `cheatsheet` `cheatsheets` `command-line` `console` `documentation` `examples` `hacktoberfest` `help` `man-page` `manpages` `manual` `shell` `terminal` `tldr`
