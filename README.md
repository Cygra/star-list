...
- [tw93/Pake](https://github.com/tw93/Pake)
  ...
  - 💡: `chatgpt` `gpt-4` `gpt-4-mobile` `high-performance` `linux-desktop` `mac` `mac-desktop` `no-electron` `open` `openai` `productivity` `rust` `tauri` `twitter` `webview` `windows-desktop` `wry` `youtube`
...
- [fslongjin/This-repo-has-1406-stars](https://github.com/fslongjin/This-repo-has-1406-stars)
  - ⭐: 1,406
  - 📖: 这个仓库有1406个star，不信你试试
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid)
  ...
  - 💡: `documentation` `flowchart` `hacktoberfest` `javascript` `typescript` `uml-diagrams`
