...
- [pmndrs/zustand](https://github.com/pmndrs/zustand)
  ...
  - 💡: `hooks` `react` `react-context` `reactjs` `redux` `state-management`
...
- [vercel/next.js](https://github.com/vercel/next.js)
  - ⭐: 113,432
  - 📖: The React Framework
  - 💡: `blog` `browser` `compiler` `components` `hacktoberfest` `hybrid` `nextjs` `node` `react` `server-rendering` `ssg` `static` `static-site-generator` `universal` `vercel`
...
- [aws/aws-toolkit-vscode](https://github.com/aws/aws-toolkit-vscode)
  ...
  - 💡: `amazon` `aws` `cdk` `cloudformation` `codecatalyst` `codewhisperer` `lambda` `s3` `serverless` `vscode` `vscode-extension`
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid)
  ...
  - 💡: `diagrams` `diagrams-as-code` `documentation` `flowchart` `hacktoberfest` `javascript` `mindmap` `typescript` `uml-diagrams`
...
- [DouyinFE/semi-design](https://github.com/DouyinFE/semi-design)
  - ⭐: 7,337
  - 📖: 🚀A modern, comprehensive, flexible design system and React UI library. 🎨 Provide more than 2800+ Design Tokens and powerful DSM tools, easy to build your own design system. Make Semi Design to Any Design
...
- [30-seconds/30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code)
  ...
  - 💡: `astro` `awesome-list` `css` `education` `es6-javascript` `git` `github-actions` `html` `javascript` `learn-to-code` `learning-resources` `netlify` `nodejs` `programming` `python` `reactjs` `snippets` `snippets-collection` `website-infrastructure`
